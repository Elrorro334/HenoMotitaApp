...
const styles = StyleSheet.create({
  ...
  modalContainer: {
    backgroundColor: colors.mainSurface,
    margin: spacing.lg,
    borderRadius: borderRadius.modal, // 16px (1rem)
    padding: spacing.xl,
    maxHeight: '85%',
    shadowColor: 'rgb(23, 53, 38)',
    shadowOffset: { width: 0, height: 24 }, // 1.5rem
    shadowOpacity: 0.28,
    shadowRadius: 64, // 4rem
    elevation: 12,
    borderWidth: 1,
    borderColor: colors.borderLight,
    borderLeftWidth: layout.panelAccentBorderWidth,
  ...
  closeBtn: {
    padding: 6,
    borderRadius: borderRadius.circle, // Circular close button
    backgroundColor: colors.secondaryButton,
  },
  ...
  scoreChipBtn: {
    width: 32,
    height: 32,
    borderRadius: borderRadius.circle, // circular button
    backgroundColor: colors.mainSurface,
    borderWidth: 1,
    borderColor: colors.borderLight,
    justifyContent: 'center',
